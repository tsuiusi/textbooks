...
![multithreading](src/multithreading.png)
...
![components](src/minixcomponents.png)  
...
![system tasks](src/systemtasks.png)

(i'll similarly skip the implementation part in notes. skimmed it. page 216 in the pdf)
